...
//		String ip = "219.136.134.157";
		...
		String country = JSONObject.parseObject(json.getString("data")).getString("country");
		String region = JSONObject.parseObject(json.getString("data")).getString("region");
		String city = JSONObject.parseObject(json.getString("data")).getString("city");
		String county = JSONObject.parseObject(json.getString("data")).getString("county");
		String isp = JSONObject.parseObject(json.getString("data")).getString("isp");
		String area = JSONObject.parseObject(json.getString("data")).getString("area");
